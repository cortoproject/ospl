...
corto_void _test_Array_setup(test_Array this) {
...
corto_void _test_Array_tc_array(test_Array this) {
/* $begin(test/Array/tc_array) */
    ...
    corto_type t = i->members.buffer[0]->type;
    test_assert(t != NULL);
...
corto_void _test_Array_tc_arrayDouble(test_Array this) {
/* $begin(test/Array/tc_arrayDouble) */
    ...
    corto_type t = i->members.buffer[1]->type;
    test_assert(t != NULL);
    test_assert(corto_typeof(t) == corto_type(corto_array_o));
...
corto_void _test_Array_tc_arrayMultiple(test_Array this) {
/* $begin(test/Array/tc_arrayMultiple) */
    ...
    corto_type t = i->members.buffer[2]->type;
    test_assert(t != NULL);
    test_assert(t == corto_type(corto_int32_o));

    t = i->members.buffer[3]->type;
    test_assert(t != NULL);
    test_assert(corto_typeof(t) == corto_type(corto_array_o));
...
corto_void _test_Array_tc_arrayMultipleDouble(test_Array this) {
/* $begin(test/Array/tc_arrayMultipleDouble) */
    ...
    corto_type t = i->members.buffer[4]->type;
    test_assert(t != NULL);
    test_assert(t == corto_type(corto_int32_o));

    t = i->members.buffer[5]->type;
    test_assert(t != NULL);
    test_assert(corto_typeof(t) == corto_type(corto_array_o));
...
corto_void _test_Array_tc_arrayMultipleNestedTriple(test_Array this) {
/* $begin(test/Array/tc_arrayMultipleNestedTriple) */
    ...
    corto_type t = i->members.buffer[10]->type;
    test_assert(t != NULL);
    test_assert(t == corto_type(n));

    t = i->members.buffer[11]->type;
    test_assert(t != NULL);
    test_assert(t == corto_type(n));

    t = i->members.buffer[12]->type;
    test_assert(t != NULL);
    test_assert(corto_typeof(t) == corto_type(corto_array_o));
...
corto_void _test_Array_tc_arrayMultipleTriple(test_Array this) {
/* $begin(test/Array/tc_arrayMultipleTriple) */
    ...
    corto_type t = i->members.buffer[7]->type;
    test_assert(t != NULL);
    test_assert(corto_typeof(t) == corto_type(corto_array_o));
...
corto_void _test_Array_tc_arrayTriple(test_Array this) {
/* $begin(test/Array/tc_arrayTriple) */
    ...
    corto_type t = i->members.buffer[6]->type;
    test_assert(t != NULL);
    test_assert(corto_typeof(t) == corto_type(corto_array_o));
