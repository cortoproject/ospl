...
corto_void _test_ValueType_setup(test_ValueType this) {
...
corto_void _test_ValueType_tc_attribute(test_ValueType this) {
...
corto_void _test_ValueType_tc_attributeEnum(test_ValueType this) {
/* $begin(test/ValueType/tc_attributeEnum) */
    ...
    test_assert(i->members.buffer[4]->type == corto_type(e));
...
corto_void _test_ValueType_tc_attributeMulti(test_ValueType this) {
/* $begin(test/ValueType/tc_attributeMulti) */
    ...
    test_assert(i->members.buffer[2]->type == corto_type(corto_int32_o));
...
corto_void _test_ValueType_tc_attributeReadonly(test_ValueType this) {
/* $begin(test/ValueType/tc_attributeReadonly) */
    ...
    test_assert(i->members.buffer[3]->type == corto_type(corto_string_o));
    test_assert(i->members.buffer[3]->modifiers == CORTO_READONLY);
...
corto_void _test_ValueType_tc_attributeStruct(test_ValueType this) {
/* $begin(test/ValueType/tc_attributeStruct) */
    ...
    test_assert(i->members.buffer[5]->type == corto_type(s));
...
corto_void _test_ValueType_tc_methodInParam(test_ValueType this) {
...
corto_void _test_ValueType_tc_methodOutParam(test_ValueType this) {
...
corto_void _test_ValueType_tc_methodOutParamNonRef(test_ValueType this) {
...
corto_void _test_ValueType_tc_methodReturn(test_ValueType this) {
...
corto_void _test_ValueType_tc_methodTwoParams(test_ValueType this) {
