...
corto_void _test_Typedef_setup(test_Typedef this) {
...
corto_void _test_Typedef_tc_array(test_Typedef this) {
/* $begin(test/Typedef/tc_array) */
    ...
    corto_type t = i->members.buffer[5]->type;
    test_assert(t != NULL);
    test_assert(t == alias);
...
corto_void _test_Typedef_tc_arrayOfStruct(test_Typedef this) {
...
corto_void _test_Typedef_tc_multiDeclarator(test_Typedef this) {
...
corto_void _test_Typedef_tc_sequence(test_Typedef this) {
/* $begin(test/Typedef/tc_sequence) */
    ...
    corto_type t = i->members.buffer[3]->type;
    test_assert(t != NULL);
    test_assert(t == alias);
...
corto_void _test_Typedef_tc_sequenceNested(test_Typedef this) {
...
corto_void _test_Typedef_tc_simple(test_Typedef this) {
